...
function [d dTname lenTname] = getmdata_xh_ch12_13(trialsdir, trialtype,trialnums,cut,oth)
...
for i = 1:length(trialnums)
  ...
  chan12_13_temp = tdata.data;
  d(i).chan12 = chan12_13_temp(3,:)';
  d(i).chan13 = chan12_13_temp(4,:)';
