...
trialsdir = pname;
cd(trialsdir);
[d dTname lenTname] = getmdata_xh_ch12_13_14(trialsdir, 'c,');
...
x2_single_double     = [1:7];
x2_double_single     = [8:14];
x2_Nsingle_Ndouble     = [15:21];
x2_Ndouble_Nsingle     = [22:28];
...
x_len = linspace(log(20),log(80),5);
dif = x_len(2)-x_len(1);
x_len = [x_len(1)-dif x_len x_len(5)+dif];
