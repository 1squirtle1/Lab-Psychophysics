...
%%%Modified by Anjani on 12/21/2017
function [d dTname lenTname] = getmdata_xh_ch12_13_1(trialsdir, trialtype,trialnums,cut,oth)
...
for i = 1:length(trialnums)
  ...
  d(i).chan12 = chan6_14_temp(7,:)';
  d(i).chan13 = chan6_14_temp(8,:)';
  d(i).chan14 = chan6_14_temp(9,:)';
  
  
  %trialnames(i)=tdata.trialname;
